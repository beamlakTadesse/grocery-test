  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: BlocBuilder<ItemdetailsTwoBloc, ItemdetailsTwoState>(
              ...
              return state is LoadingProductState
                  ...
                  : state is LoadedProductState
                                      ...
                                      children: [
                                        CarouselSlider.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              return SliderItemWidget(state.data
                                                  .data.detailImages[index]);
                                            }),
                                        Align(
                                                                ...
                                                                Align(
                                                                    ...
                                                                    child: Column(
                                                                        ...
                                                                        children: [
                                                                          Opacity(
                                                                              opacity: 0.9,
                                                                              child: Text(state.data.data.name, style: CustomTextStyles.headlineSmallPoppinsBlack900)),
                                                                          Padding(
                                                                              padding: getPadding(top: 13),
                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                                                Text(state.data.data.discount.tr, style: CustomTextStyles.headlineSmallPoppinsPrimary),
                                                                                Container(
                                                                                    ...
                                                                                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                      Container(height: getVerticalSize(3), width: getHorizontalSize(15), margin: getMargin(top: 13, bottom: 13), decoration: BoxDecoration(color: theme.colorScheme.primary)),
                                                                                      Padding(padding: getPadding(left: 25), child: Text("lbl_3".tr, style: CustomTextStyles.titleLargeMedium)),
                                                                                      CustomImageView(svgPath: ImageConstant.imgGridPrimary, height: getSize(15), width: getSize(15), margin: getMargin(left: 20, top: 7, bottom: 7))
                                                                                    ]))
                                                                              ]))
                                                                        ])),
                      ...
                      : state is LoadedProductErrorState
                          ? Center(
