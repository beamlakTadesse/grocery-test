...
class CustomTextFormField extends StatelessWidget {
  ...
  InputDecoration get decoration => InputDecoration(
        ...
        errorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(getHorizontalSize(19.00)),
          borderSide: BorderSide(
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlineGrayTL301 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(getHorizontalSize(30.00)),
        borderSide: BorderSide(
          color: appTheme.gray40003,
          width: 1,
  ...
  static OutlineInputBorder get outlineYellowTL29 => OutlineInputBorder(
  ...
  static OutlineInputBorder get outlineYellowTL18 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(getHorizontalSize(18.00)),
        borderSide: BorderSide(
          color: appTheme.yellow900,
          width: 1,
